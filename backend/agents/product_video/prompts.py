...
1. Based on the selected concept, write a Veo video prompt (50-175 words):
   ...
   - SYNC AUDIO TO VISUAL ACTION: Because the video and audio are generated by AI simultaneously, you must write the voiceover so its natural spoken pacing aligns with the visual sequence. For example, the first third of the script should match the "Setup" visual, the middle matches the "Action/Interaction", and the final words land perfectly on the "Payoff/Logo Reveal".
